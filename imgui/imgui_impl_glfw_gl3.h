...
IMGUI_API const char *ImGui_ImplGlfwGL3_GetClipboardText(void *user_data);
IMGUI_API void ImGui_ImplGlfwGL3_SetClipboardText(void *user_data, const char *text);
